 ...
 *JUSTIFICATIFS (4/4)
 */
if(((TypeTitreDeSejour == "RenouvellementDeTitreSejour") || (TypeTitreDeSejour == "Visiteur")) && ((ChangementSituation == 'Perte') || (ChangementSituation == 'Vol') || (ChangementSituation == 'Deterioration')) && ((Titre == 'Visiteur') || (Titre == 'Etudiant'))) {
	//INFORMATIONS PERSONNELLES (1/4)
