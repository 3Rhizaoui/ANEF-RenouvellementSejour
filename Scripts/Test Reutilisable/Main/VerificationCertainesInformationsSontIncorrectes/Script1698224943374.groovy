...
MsgAlertPresent = WebUI.verifyElementVisible(findTestObject('Object Repository/Connexion Usager/lbl_CertainesInformationsSaisiesSontIncorrectes'), FailureHandling.OPTIONAL)
