...
WebUI.callTestCase(findTestCase('Test Réutilisable/Main/Lancer URL ANEF'), ['Portail':'Agent'], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('Test Réutilisable/Main/Identification'), ['Portail':'Agent'], FailureHandling.STOP_ON_FAILURE)
