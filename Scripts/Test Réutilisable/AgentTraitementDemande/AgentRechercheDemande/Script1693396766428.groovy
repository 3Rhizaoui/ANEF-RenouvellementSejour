...
WebUI.callTestCase(findTestCase('Test Cases/Test Réutilisable/AgentTraitementDemande/ConnexionPositionnementSiteDeTraitementAgent'), [:], FailureHandling.STOP_ON_FAILURE)

'recherche de la demande En cours'
//WebUI.click(findTestObject('Object Repository/Page_Accueil_Agent/span_DemandeDeTitreDeSéjour'))
WebUI.click(findTestObject('Object Repository/Page_Accueil_Agent/span_Liste_MesDemandes'))
WebUI.click(findTestObject('Object Repository/Page_Accueil_Agent/a_link_TitreDeSéjour'))
